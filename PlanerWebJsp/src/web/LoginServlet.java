...
public class LoginServlet extends HttpServlet {
	 ...
	 * (initialContext == null) { initialContext = new InitialContext(); } return
	 * initialContext; }
	 * 
	 * private String getLookupName() { final String appName = "PlanerEar"; final
	 * String moduleName = "PlanerEJB"; final String distinctName = ""; final String
	 * beanName = PlannerBean.class.getSimpleName(); final String interfaceName =
	 * PlannerBeanRemote.class.getName(); String lookUp = "ejb:" + appName + "/" +
	 * moduleName + "/" + distinctName + "/" + beanName + "!" + interfaceName +
	 * "?stateful"; return lookUp; }
	 * 
